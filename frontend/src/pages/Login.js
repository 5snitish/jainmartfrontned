    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <div className="logo">
                  <h4 className = 'white'> welcome to jain grocery and kirana store </h4>
                        ...
                        <form id="sign_in" method="POST" onSubmit = {this.formSubmit}>
                            ...
                            <div className="input-group">
                                ...
                                <div className="form-line">
                                    <input type="text" className="form-control" name="username" placeholder="Username" required autofocus  onChange ={this.saveInputs}></input>
                                </div>
                            </div>
                            <div className="input-group">
                                <span className="input-group-addon">
                                ...
                                <div className="form-line">
                                    <input type="password" className="form-control" name="password" placeholder="Password" required onChange ={this.saveInputs} ></input>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-xs-8 p-t-5">
                                    <input type="checkbox" name="rememberme" id="rememberme" className="filled-in chk-col-pink"  ></input>
